...
Quick links to Threat Thinker docs.

- **Tutorials**: Examples for web, AWS, and diff workflows — [`docs/tutorials.md`](tutorials.md)
- **CLI Quick Reference**: Common flags for think/diff — [`docs/cli.md`](cli.md)
